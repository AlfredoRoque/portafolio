...
export class MenuComponent implements OnInit {
  ...
  proyects:ProyectData[] = [
    ...
    new ProyectData('https://github.com/AlfredoRoque/payments','https://payments-production-4a56.up.railway.app/swagger-ui/index.html', '../../assets/images/stripe-payments.png', 'API de Pagos con Stripe'),
